...
<p> Tid som er valgt allerede for denne datoen er : 
  <?php   foreach($unavailableTimes as $tempTime){ 
        ...
        <div class="timeButton">
             <table>
                  ...
                  <tr>
                    ...
                    <td><input type="radio" id="<?php echo $time?>" value="<?php echo $time?>" name="time">
                        <label id="<?php echo "label" . $time ?>" for="<?php echo $time?>"><?php echo $time ?></label>
                    </td>
                     <?php }?>
                  </tr>
                   <tr>
