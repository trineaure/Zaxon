...
<html lang="no">
    ...
    <head>
        ...
        <title>Zaxon</title>
        <link rel="stylesheet" href="../fellesFiler/css/style.css" />
       <link rel="stylesheet" type="text/css" href="../fellesFiler/css/jquery.datetimepicker.css"/> 
    ...
    <body>
        ...
        <div class="container">
            ...
            <nav>
                ...
                <header>
                    <div class="logo">
                        <a href="?page=home"><img src="../fellesFiler/bilder/nylogo.png" alt=""></a>
                    </div>
                </header>
                <!-- END -->
                ...
                <div class="nav-bar">
                    ...
                    <ul>
                        ...
                        <li><a href="?page=order">Bestill time</a></li>
                        <li><a href="?page=pricelist">Prisliste</a></li>
                        <li><a href="?page=aboutus">Om oss</a></li>
                        <li><a href="?page=contact">Kontakt</a></li>
                         <li><a href="../guest/?page=home">Logg Ut</a></li>
                    </ul>
                </div>
            </nav>
            <!-- END -->
